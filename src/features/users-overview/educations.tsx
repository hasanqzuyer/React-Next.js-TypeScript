...
const Education = (props: any) => {
    ...
    const handleSave = () => {
        ...
        handleInsert()
            ...
            .catch((error) => {
                push('Something went wrong when adding educations.', { variant: 'error' });
                setSaveState(oldStates => ({
                    ...oldStates,
                    'Inserted': true
                }))
        ...
        handleUpdate()
            ...
            .catch((error) => {
                push('Something went wrong when updating educations.', { variant: 'error' });
                setSaveState(oldStates => ({
                    ...oldStates,
                    'Updated': true
                }))
        ...
        handleDeleteing()
            ...
            .catch((error) => {
                push('Something went wrong when deleting educations.', { variant: 'error' });
                setSaveState(oldStates => ({
                    ...oldStates,
                    'Deleted': true
                }))
                    ...
                    return (
                        <AccountGrid style={{ position: 'relative', marginBottom: '20px' }}>
                            <Input
                                ...
                                onValue={(university) => handleChange("university", university ? university.value : university, education.id)}
                            />
                            ...
                            <Input
                                ...
                                onValue={(degree) => handleChange("degree", degree ? degree.value : degree, education.id)}
                            />
                            <Input
                                type="select"
                                ...
                                onValue={(fieldOfStudy) => handleChange("fieldOfStudy", fieldOfStudy ? fieldOfStudy.value : fieldOfStudy, education.id)}
                            />
                            ...
                            <Input
                                ...
                                onValue={(overAllGPA) => handleChange("overAllGPA", overAllGPA, education.id)}
                            />
                            <Stack
                                style={{
                                    position: 'absolute',
                            ...
                            >
                                <Stack style={{ cursor: 'pointer' }} onClick={() => handleDelete(education.id)}>
