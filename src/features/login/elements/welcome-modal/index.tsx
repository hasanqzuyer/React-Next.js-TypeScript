  ...
  return error ? (
    <Modal size="medium" onClose={onClose} {...props}>
      <SWelcomeModalMain columns={1}>
        ...
        <SWelcomeModalText>
          {t(
            "We're sorry, but we were unable to confirm your account with the link you clicked. Please check your email for a new confirmation link, as the old one may have expired. If you continue to experience issues, our team at support@brotherhoodhouse.com.com is always here to assist you and ensure your account is fully activated."
          )}
        </SWelcomeModalText>
      </SWelcomeModalMain>
    </Modal>
    ...
    <Modal size="large" onClose={onClose} {...props}>
      <SWelcomeModalMain columns={1}>
        <SWelcomeModalTitle>
          {t(!role ? 'Please Wait' : 'Welcome to Brotherhood House!')}
        </SWelcomeModalTitle>
        {role === 'INFLUENCER' && (
          <SWelcomeModalText>
            {t(
